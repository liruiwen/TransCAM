...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", type=str, default='data/resnet38_aff.pth')
    parser.add_argument("--network", default="network.resnet38_aff", type=str)
    parser.add_argument("--infer_list", default="voc12/train_aug.txt", type=str)
    parser.add_argument("--num_workers", default=0, type=int)
    parser.add_argument("--cam_dir", type=str, default='data/transcam/out_cam')
    parser.add_argument("--voc12_root", default='VOCdevkit/VOC2012', type=str)
    parser.add_argument("--bkg", default=0.42, type=float)
    parser.add_argument("--out_rw", default='data/transcam/out_rw', type=str)
    ...
    for iter, (name, img) in enumerate(infer_data_loader):
        ...
        with torch.no_grad():
            ...
            if args.crf:
                ...
                Image.fromarray(crf.astype(np.uint8)[:orig_shape[2], :orig_shape[3]]).save(os.path.join(args.out_rw, name + '.png'))
            else:
